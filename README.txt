To run the program, go to the directory that includes the project.
In the terminal run:
     gcc -o run CommandLine.c Symbol.c Table.c ParamFunction.c Function.c Variable.c ExpressionUtils.c Expression.c
